...
double pendulum_formula(double pendulum_period, double pendulum_length, double acceleration_of_gravity){
    if (pendulum_period == -1){
        ...
        return (4 * pow(pi, 2) * pendulum_length)
                / (pow(pendulum_period, 2));
    } else {
...
int main() {
    ...
    switch (choose_formula){
        case 1:
        {
            double speed_light_medium = input_prompt("Enter the speed of light in the medium: ");
        ...
        case 3:
        {
            double pendulum_period = input_prompt("Enter pendulum period (enter -1 if unknown): ");
            double pendulum_length = input_prompt("Enter pendulum length (enter -1 if unknown): ");
            double acceleration_of_gravity = input_prompt("Enter acceleration of gravity (enter -1 if unknown, Earth is 9.80665): ");
